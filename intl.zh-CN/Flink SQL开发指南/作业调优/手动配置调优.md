...
1.  分析问题
    1.  通过Job的拓扑图查看到2号的Task节点的输入队列已达到100%，造成上游1号节点的数据堆积，输出队列造成数据堆积。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41064/156807925933889_zh-CN.png)
...
-   **暂停** \> **启动**步骤如下：
    ...
    4.  在**恢复作业运行**，单击**按最新配置恢复**。
        ...
        ![resume](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41064/156807925935718_zh-CN.png)
