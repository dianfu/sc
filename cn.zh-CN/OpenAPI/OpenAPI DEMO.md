...
## POM依赖 {#section_c83_tsr_jw5 .section}

``` {#codeblock_fy4_ctc_2lh .language-java}
<dependency>
...
## OpenAPI DEMO {#section_cww_6bw_785 .section}

``` {#codeblock_d8j_r2w_7qd .language-java}
package sample;
