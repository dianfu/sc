...
![滑动窗口](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/40913/156463525234327_zh-CN.png)
...
**说明：** HOP窗口中不设置窗口的开启时间，第一个窗口的开启时间会前移。前移时长=窗口时长-滑动步长，示例如下表。
