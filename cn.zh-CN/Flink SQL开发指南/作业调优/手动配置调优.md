...
1.  分析问题
    1.  通过Job的拓扑图查看到2号的Task节点的输入队列已达到100%，造成上游1号节点的数据堆积，输出队列造成数据堆积。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41064/156808161533889_zh-CN.png)
...
-   **暂停** \> **启动**步骤如下：
    ...
    4.  在**恢复作业运行**，单击**按最新配置恢复**。
        ...
        ![resume](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41064/156808161535718_zh-CN.png)

-   **停止** \> **启动**步骤如下：
    1.  停止作业。停止作业步骤参见[停止](intl.zh-CN/Flink SQL开发指南/作业开发/停止.md#)。
    2.  启动作业。启动作业步骤参见[启动](intl.zh-CN/Flink SQL开发指南/作业开发/启动.md#)。
